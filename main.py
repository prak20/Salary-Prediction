...
def graph(X_train,Y_train,regressionObject,X_test,Y_test,Y_pred):
    ...
    plt.plot(X_train,regressionObject.predict(X_train),color='blue',label='BestFit')
...
def main():
    ...
    try:
        ...
        print("Now U can predict salary of an employee using our model")
        print("\nEnter experience in years of candidates, seperated by comma")
